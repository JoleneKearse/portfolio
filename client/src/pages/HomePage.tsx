...
export function HomePage() {
  return (
    <main className="flex flex-col gap-20 mx-auto max-w-prose">
      <IntroHeading />
      <div className="md:justify-evenly md:flex md:gap-12">
        <div className="w-2/3 mx-auto bg-center bg-no-repeat bg-cover rounded-t-none bg-code md:bg-right-top outline">
          <img
            src={Jolene}
        ...
        <div className="mt-20 text-balance md:mt-0 md:flex md:flex-col md:justify-center outline md:gap-2">
